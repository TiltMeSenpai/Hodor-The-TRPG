...
/**
 * This is the archer class which extends a basic {@link Unit}
...
public class Archer extends Unit {
	...
	/**
	 * This is the constructor to create a new archer.
    ...
    public Archer(int x, int y, String name, House house, int hp, int str, int def, int evasion, int movement, int range){
    ...
    /**
     * This is the attack method for how an archer class can attack another {@link Unit}
